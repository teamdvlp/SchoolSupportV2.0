...
import com.teamttdvlp.goodthanbefore.schoolsupport.data.entities.story.CompactStory
            ...
            .addOnCompleteListener {
                if (it.isSuccessful) {
                    ...
                    for (doc in it.result!!.documents) {
                        var obj : CompactStory? =  doc.toObject(
                            CompactStory::class.java)
                        if (obj != null) {
